<div class="space-y-4">
    <div class="p-4 bg-white rounded-lg shadow">
        <div class="space-y-2">
            <h3 class="text-lg font-medium">{{ $record->name }}</h3>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        ...
        @elseif(str_contains($record->mime_type, 'pdf'))
            <iframe src="{{ Storage::disk('public')->url($record->file_path) }}" 
        ...
        @else
            <div class="p-8 text-center">
                <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100 mb-4">
                    @if(str_contains($record->mime_type, 'word'))
                    ...
                    @elseif(str_contains($record->mime_type, 'spreadsheet') || str_contains($record->mime_type, 'excel'))
                    ...
                    @elseif(str_contains($record->mime_type, 'csv'))
                ...
                <p class="mt-2 text-sm text-gray-500">{{ number_format($record->size / 1024, 2) }} KB</p>
                <a href="{{ Storage::disk('public')->url($record->file_path) }}" 
